import '../shopping_in_person_screen/widgets/listautolayouthor_one_item_widget.dart';
...
class ShoppingInPersonScreen extends GetWidget<ShoppingInPersonController> {
                                                        ...
                                                        child: Obx(() =>
                                                            ListView.separated(
                                                                ...
                                                                itemCount: controller
                                                                    .shoppingInPersonModelObj
                                                                    .value
                                                                    .listautolayouthorOneItemList
                                                                    .length,
                                                                itemBuilder:
                                                                    (context,
                                                                        index) {
                                                                  ListautolayouthorOneItemModel
                                                                      model =
                                                                      controller
                                                                          .shoppingInPersonModelObj
                                                                          .value
                                                                          .listautolayouthorOneItemList[index];
                                                                  return ListautolayouthorOneItemWidget(
                                                                      model);
                                                                })))),
                                                Container(
                                                    height:
