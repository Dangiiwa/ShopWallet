...
class ListautolayouthorOne2ItemWidget extends StatelessWidget {
  ListautolayouthorOne2ItemWidget(this.listautolayouthorOne2ItemModelObj);

  ListautolayouthorOne2ItemModel listautolayouthorOne2ItemModelObj;

  var controller = Get.find<ShoppingInPerson3Controller>();
