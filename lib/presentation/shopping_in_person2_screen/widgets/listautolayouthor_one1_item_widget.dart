...
class ListautolayouthorOne1ItemWidget extends StatelessWidget {
  ListautolayouthorOne1ItemWidget(this.listautolayouthorOne1ItemModelObj);

  ListautolayouthorOne1ItemModel listautolayouthorOne1ItemModelObj;

  var controller = Get.find<ShoppingInPerson2Controller>();
