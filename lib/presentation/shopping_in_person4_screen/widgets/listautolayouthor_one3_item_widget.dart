...
class ListautolayouthorOne3ItemWidget extends StatelessWidget {
  ListautolayouthorOne3ItemWidget(this.listautolayouthorOne3ItemModelObj);

  ListautolayouthorOne3ItemModel listautolayouthorOne3ItemModelObj;

  var controller = Get.find<ShoppingInPerson4Controller>();
