import '../wallet_screen/widgets/listuser_one_item_widget.dart';
import 'controller/wallet_controller.dart';
import 'models/listuser_one_item_model.dart';
import 'package:flutter/material.dart';
import 'package:shopwallet/core/app_export.dart';
import 'package:shopwallet/data/models/getUserDetailsByWalletAlias/post_get_user_details_by_wallet_alias_req.dart';
...
class WalletScreen extends GetWidget<WalletController> {
                                ...
                                child: Container(
                                    ...
                                    child: Row(
                                        ...
                                        children: [
                                          GestureDetector(
                                              onTap: () {
                                                onTapTxtGoodmorningj();
                                              },
                                              child: Text(
                                                  "msg_good_morning_j".tr,
                                                  overflow:
                                                            ...
                                                            child: Obx(() => ListView
                                                                .separated(
                                                                    ...
                                                                    itemBuilder:
                                                                        (context,
                                                                            index) {
                                                                      ListuserOneItemModel
                                                                          model =
                                                                          controller
                                                                              .walletModelObj
                                                                              .value
                                                                              .listuserOneItemList[index];
  ...
  void onTapTxtGoodmorningj() {
    PostGetUserDetailsByWalletAliasReq postGetUserDetailsByWalletAliasReq =
        PostGetUserDetailsByWalletAliasReq(
      walletAlias: Get.find<PrefUtils>().getAlias(),
    );
    controller.callCreateGetUserDetailsByWalletAlias(
      postGetUserDetailsByWalletAliasReq.toJson(),
      successCall: _onCreateGetUserDetailsByWalletAliasSuccess,
      errCall: _onCreateGetUserDetailsByWalletAliasError,
    );
  }

  void _onCreateGetUserDetailsByWalletAliasSuccess() {
    Get.find<PrefUtils>().setUserProfile(
        controller.postGetUserDetailsByWalletAliasResp.response!.toString());
    Get.snackbar('', "Profile Loaded.");
  }

  void _onCreateGetUserDetailsByWalletAliasError() {
    Get.defaultDialog(
        onConfirm: () => Get.back(),
        title: "Profile Error",
        middleText: "Profile not loaded properly, logout.");
  }

  onTapImgGroupTwo() {
    Get.toNamed(AppRoutes.vCardScreen);
  }
